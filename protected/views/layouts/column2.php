    ...
    <div id="bd" class="dft">
        <div class="set-bd">
            <div class="grid-2 clearfix">
                <div class="article">
                    <iframe name="setting" id="setting" style="width:100%;border:0;background:none;" src="<?php echo $action['href'];?>" frameborder="0" scrolling="no" height="1011"></iframe>
                </div>
                <div class="aside">
                    <div class="mod-setting-nav" style="height: 1011px;">
                        <ul class="nav-list clearfix">
                            <?php foreach($this->menu as $k=>$v){ ?>
                            <li class="nav-item<?php echo $k==$action['class']?" active":""?>">
                                <h3 class="nav-hd">
